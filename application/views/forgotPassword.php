...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SS | Login to SS Tours System</title>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <a href="#"><b>SS</b><br>Tours & Travels</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form id="forgot" action="<?php echo base_url(); ?>resetPasswordUser" method="post">
...
<script src="<?php echo base_url(); ?>assets/js/forgot_password.js" type="text/javascript"></script>
