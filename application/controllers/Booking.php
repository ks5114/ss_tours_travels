...
class Booking extends BaseController
{
    ...
    function bookings()
    {
        ...
        $this->global['pageTitle'] = 'SS : Bookings';
    ...
    {
        $this->global['pageTitle'] = 'SS : Book the room';
    ...
    function editOldBooking($bookingId = NULL)
    {
        ...
        $this->global['pageTitle'] = 'SS : Edit Booking - '. $bookingDetails->customerName . ' (' . date('Y-m-d', strtotime($bookingDetails->bookStartDate)) . ' to '. date('Y-m-d', strtotime($bookingDetails->bookEndDate)) . ' )';
